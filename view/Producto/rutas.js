...
import { getAllProducts, createProduct, editProduct, deleteProduct } from "../../Controller/Producto/productoController.js";
...
rutasProduct.route('/product/:id').delete((req, res)=>{
